...
def analyze_btc_price():
    ...
    if percentage_diff_current < 0:
        print(
            f"Current price is {percentage_diff_current:.2f}% lower than the last 5-minute candle")
    else:
        print(
            f"Current price is {percentage_diff_current:.2f}% higher than the last 5-minute candle")
