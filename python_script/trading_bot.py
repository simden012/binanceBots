...
from rsi_binance_requests import calculate_rsi
import time
...
while True:
    ...
    for symbol in symbols:
        ...
        if current_price < lower_band and rsi_value < 30:
            quantity_buy = user123.cash_to_quantity(symbol, money_per_trade)
            ...
            print(f"NOTHING to do for {symbol} with price at {round(current_price, 3)}$")
