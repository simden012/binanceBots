from python_script.indicators_calculator.bolling_bands_requests import lower_bolling_band, calculate_bolling_bands
...
while True:
    ...
    for ticker in tickers:
        ...
        if (difference_price_lower/difference_lower_mid <= 0.5):
            ...
            print(
                f"NOTHING to do for {ticker} with price at {round(price, 3)}$")
